...
public class ResourceManager {
    ...
    public GameObject Instantiate(GameObject prefab, Transform parent, bool control = true) {
        if (prefab == null) {
            return null;
        }
    ...
    public GameObject Instantiate(string path, Transform parent, bool control = true) {
        if (resourcePrefab.ContainsKey(path)) {
            return Instantiate(resourcePrefab[path], parent);
        }
        ...
        return Instantiate(prefab, parent, control);
    }
